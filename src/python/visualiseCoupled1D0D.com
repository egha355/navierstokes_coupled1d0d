...
#gfx def field pH component Deriv.1
...
gfx modify spectrum Pressure log exaggeration 1000 reverse range 0.0 60.0 extend_above extend_below rainbow colour_range 0 1 component 1;
...
gfx modify g_element ArterialSystem node_points data flow spectrum Flow #label cmiss_number
gfx modify g_element ArterialSystem cylinders constant_radius 0.5 data flow spectrum Flow radius_scalar radii scale_factor 0.5 tessellation default
...
gfx modify window 1 view eye_point -800 -1500 300;
...
#gfx print window 1 file 1.png

#gfx def faces
#gfx define field slice dot_product fields Coordinate [0 0 1]
#gfx modify g_element "/" lines domain_mesh1d coordinate Coordinate exterior face all tessellation default LOCAL line line_base_size 0 select_on material default selected_material default_selected render_shaded;
